...
class FeedbackForm(forms.ModelForm):
    ...
    def __init__( self, *args, **kwargs ):
        ...
        self.fields['feedback_contact_number'].widget.attrs['class'] = 'contactno'
        self.fields['feedback_contact_number'].label = 'Contact No'

        self.fields['feedback_name'].widget.attrs['class'] = 'name'
        self.fields['feedback_name'].label = 'Name'

        self.fields['feedback_email'].widget.attrs['class'] = 'email'
        ...
        self.fields['feedback'].widget.attrs['class'] = 'textarea'
